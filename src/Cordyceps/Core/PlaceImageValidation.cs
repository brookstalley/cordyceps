...
namespace Cordyceps.Core
{
    ...
    ///
    /// Validates the value constraints of a PictureFrame placement request — the file must
    /// exist and the dimensions must be positive. Presence/required-ness of the numeric
